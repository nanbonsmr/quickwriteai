...
import { Loader2, Copy, Bot, Hash, Sparkles, Lightbulb, ArrowRight } from 'lucide-react';
        ...
        <div className="container max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Try our powerful AI generators without signing up. Generate ChatGPT prompts and hashtags instantly!
            </p>
          </div>
